...
procedure EnumerateVTClipboardFormats(TreeClass: TojVirtualTreeClass; const List: TStrings); overload;
procedure EnumerateVTClipboardFormats(TreeClass: TojVirtualTreeClass; var Formats: TFormatEtcArray); overload;
function GetVTClipboardFormatDescription(AFormat: Word): string;
procedure RegisterVTClipboardFormat(AFormat: Word; TreeClass: TojVirtualTreeClass; Priority: Cardinal); overload;
function RegisterVTClipboardFormat(const Description: string; TreeClass: TojVirtualTreeClass; Priority: Cardinal;
...
type
  ...
  public
    ...
    TreeClass: TojVirtualTreeClass;      // The tree class which supports rendering this format.
  ...
  public
    class procedure Add(const FormatString: string; AClass: TojVirtualTreeClass; Priority: Cardinal; AFormatEtc: TFormatEtc);
    class procedure Clear;
    class procedure EnumerateFormats(TreeClass: TojVirtualTreeClass; var Formats: TFormatEtcArray;  const AllowedFormats: TClipboardFormats = nil); overload;
    class procedure EnumerateFormats(TreeClass: TojVirtualTreeClass; const Formats: TStrings); overload;
    class function FindFormat(const FormatString: string): TClipboardFormatListEntry; overload;
    class function FindFormat(const FormatString: string; var Fmt: Word): TojVirtualTreeClass; overload;
    class function FindFormat(Fmt: Word; var Description: string): TojVirtualTreeClass; overload;
  end;
...
procedure EnumerateVTClipboardFormats(TreeClass: TojVirtualTreeClass; const List: TStrings);
...
procedure EnumerateVTClipboardFormats(TreeClass: TojVirtualTreeClass; var Formats: TFormatEtcArray);
...
procedure RegisterVTClipboardFormat(AFormat: Word; TreeClass: TojVirtualTreeClass; Priority: Cardinal);
...
class procedure TClipboardFormatList.Add(const FormatString: string; AClass: TojVirtualTreeClass; Priority: Cardinal; AFormatEtc: TFormatEtc);
...
class procedure TClipboardFormatList.EnumerateFormats(TreeClass: TojVirtualTreeClass; var Formats: TFormatEtcArray; const AllowedFormats: TClipboardFormats = nil);
...
class procedure TClipboardFormatList.EnumerateFormats(TreeClass: TojVirtualTreeClass; const Formats: TStrings);
...
class function TClipboardFormatList.FindFormat(const FormatString: string; var Fmt: Word): TojVirtualTreeClass;
...
class function TClipboardFormatList.FindFormat(Fmt: Word; var Description: string): TojVirtualTreeClass;
