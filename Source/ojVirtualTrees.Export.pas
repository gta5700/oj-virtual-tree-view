...
uses Winapi.Windows, System.SysUtils, Vcl.Graphics, System.Classes, Vcl.Forms,
     ...
     ojVirtualTrees, ojVirtualTrees.Classes;

function ContentToHTML(Tree: TojCustomVirtualStringTree; Source: TVSTTextSourceType; const Caption: string = ''): String;
function ContentToRTF(Tree: TojCustomVirtualStringTree; Source: TVSTTextSourceType): RawByteString;
function ContentToUnicodeString(Tree: TojCustomVirtualStringTree; Source: TVSTTextSourceType; const Separator: string): string;
function ContentToClipboard(Tree: TojCustomVirtualStringTree; Format: Word; Source: TVSTTextSourceType): HGLOBAL;
procedure ContentToCustom(Tree: TojCustomVirtualStringTree; Source: TVSTTextSourceType);
...
type
  TojCustomVirtualStringTreeCracker = class(TojCustomVirtualStringTree)
  end;
...
var
  ...
  CellPadding: String;
  CrackTree: TojCustomVirtualStringTreeCracker;
  lGetCellTextEventArgs: TVSTGetCellTextEventArgs;
begin
  CrackTree := TojCustomVirtualStringTreeCracker(Tree);
