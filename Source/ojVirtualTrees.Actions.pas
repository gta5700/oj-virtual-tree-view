...
type
  ...
  strict private
    fTree: TojBaseVirtualTree; // Member variable for the property "Control"
  ...
  strict protected
    ...
    procedure SetControl(Value: TojBaseVirtualTree); // Setter for the property "Control"
  ...
  published
    ...
    property Control: TojBaseVirtualTree read fTree write SetControl;
...
begin
  Result := (Target is TojBaseVirtualTree);
end;

procedure TVirtualTreeAction.UpdateTarget(Target: TObject);
begin
  if fTreeAutoDetect and (Target is TojBaseVirtualTree) then
    fTree := (Target as TojBaseVirtualTree);
...
procedure TVirtualTreeAction.SetControl(Value: TojBaseVirtualTree);
begin
...
begin
  ...
  fToExecute := procedure(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Data: Pointer; var Abort: Boolean)
                begin
