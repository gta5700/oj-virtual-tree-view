...
uses
  ...
  StdCtrls, ojVirtualTrees, ImgList, ExtCtrls, UITypes;
...
type
  TPropertiesForm = class(TForm)
    VST3: TojVirtualStringTree;
    Label9: TLabel;
    Label10: TLabel;
    TreeImages: TImageList;
    RadioGroup1: TRadioGroup;
    procedure FormCreate(Sender: TObject);
    procedure VST3Change(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
    procedure VST3CreateEditor(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; out EditLink: IVTEditLink);
    procedure VST3Editing(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
    procedure VST3GetHint(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex;  var LineBreakStyle: TVTTooltipLineBreakStyle; var HintText: UnicodeString);
    procedure VST3GetImageIndex(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Kind: TVTImageKind; Column: TColumnIndex;  var Ghosted: Boolean; var Index: TImageIndex);
    procedure VST3GetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;  var CellText: UnicodeString);
    procedure VST3InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
    procedure VST3InitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;  var InitialStates: TVirtualNodeInitStates);
    procedure VST3PaintText(Sender: TojBaseVirtualTree; const TargetCanvas: TCanvas; Node: TojVirtualNode; Column: TColumnIndex; TextType: TVSTTextType);
    procedure VST3IncrementalSearch(Sender: TojBaseVirtualTree; Node: TojVirtualNode; const Text: UnicodeString; var Result: Integer);
    procedure RadioGroup1Click(Sender: TObject);
    procedure VST3StateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
    procedure VST3_OnGetNodeUserDataClass(Sender: TojBaseVirtualTree;var NodeUserDataClass: TClass);
  private
...
procedure TPropertiesForm.VST3InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
...
procedure TPropertiesForm.VST3InitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;
  var InitialStates: TVirtualNodeInitStates);

var
  Data: TojPropertyData;
...
begin
  ...
  begin
    Data:= Node.UserData as TojPropertyData;
    Data.ValueType := Editors.ValueTypes[ParentNode.Index, Node.Index];
    if Data.ValueType = vtDate then
      Data.Value := DateToStr(Now)
    else
      Data.Value := Editors.DefaultValue[ParentNode.Index, Node.Index];
  end;
end;

//----------------------------------------------------------------------------------------------------------------------

procedure TPropertiesForm.VST3GetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex;
...
procedure TPropertiesForm.VST3GetHint(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex;
...
begin
  ...
  begin
    ...
    if (Sender as TojVirtualStringTree).Hintmode <> hmTooltip then
       HintText := HintText
...
procedure TPropertiesForm.VST3GetImageIndex(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Kind: TVTImageKind;
...
procedure TPropertiesForm.VST3Editing(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
var
  Data: TojPropertyData;
begin
  with Sender do
...
procedure TPropertiesForm.VST3Change(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
...
procedure TPropertiesForm.VST3CreateEditor(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex;
...
procedure TPropertiesForm.VST3PaintText(Sender: TojBaseVirtualTree; const TargetCanvas: TCanvas; Node: TojVirtualNode;
...
procedure TPropertiesForm.VST3IncrementalSearch(Sender: TojBaseVirtualTree; Node: TojVirtualNode; const Text: UnicodeString;
  var Result: Integer);
var
  S,
  PropText: string;
...
procedure TPropertiesForm.VST3StateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
begin
...
procedure TPropertiesForm.VST3_OnGetNodeUserDataClass(Sender: TojBaseVirtualTree; var NodeUserDataClass: TClass);
begin
  NodeUserDataClass:= TojPropertyData;
end;
...
//  this time we use Event _OnGetNodeUserDataClass
//initialization
//  TojBaseVirtualTree.registerUserDataClass(TojPropertyData);
