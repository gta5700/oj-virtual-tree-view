...
uses
  ...
  StdCtrls, Buttons, ojVirtualTrees, ComCtrls, ExtCtrls, ImgList, Menus, UITypes;

type
  TAlignForm = class(TForm)
    AlignTree: TojVirtualStringTree;
    Label8: TLabel;
    ...
    procedure AlignTreeGetImageIndex(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Kind: TVTImageKind; Column: TColumnIndex;
      var Ghosted: Boolean; var Index: TImageIndex);
    procedure AlignTreeGetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;
      var CellText: UnicodeString);
    procedure AlignTreePaintText(Sender: TojBaseVirtualTree; const Canvas: TCanvas; Node: TojVirtualNode; Column: TColumnIndex;
      TextType: TVSTTextType);
    procedure AlignTreeGetNodeDataSize(Sender: TojBaseVirtualTree; var NodeDataSize: Integer);
    procedure AlignTreeInitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;
      var InitialStates: TVirtualNodeInitStates);
    procedure AlignTreeInitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
    ...
    procedure AlignTreeFocusChanged(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex);
    procedure AlignTreeStateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
    procedure AlignTreeFreeNode(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
    procedure AlignTree_OnGetNodeUserDataClass(Sender: TojBaseVirtualTree; var NodeUserDataClass: TClass);
  private
    FArabicFont,
    FHebrewFont: TFont;
...
procedure TAlignForm.AlignTreeGetNodeDataSize(Sender: TojBaseVirtualTree; var NodeDataSize: Integer);
...
procedure TAlignForm.AlignTreePaintText(Sender: TojBaseVirtualTree; const Canvas: TCanvas; Node: TojVirtualNode;
...
procedure TAlignForm.AlignTreeGetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex;
  TextType: TVSTTextType; var CellText: UnicodeString);
var
  Data: TAlignData;
begin
  //Data := Sender.GetNodeData(Node);
  Data:= Node.UserData as TAlignData;
  case Column of
...
procedure TAlignForm.AlignTreeGetImageIndex(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Kind: TVTImageKind;
...
procedure TAlignForm.AlignTreeInitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;
  var InitialStates: TVirtualNodeInitStates);
var
  Data: TAlignData;
begin
...
procedure TAlignForm.AlignTreeInitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
begin
  if not Odd(Node.Index) then
...
procedure TAlignForm.AlignTreeFocusChanged(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex);
const
...
procedure TAlignForm.AlignTreeStateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
begin
  if not (csDestroying in ComponentState) then
    UpdateStateDisplay(Sender.TreeStates, Enter, Leave);
end;

procedure TAlignForm.AlignTree_OnGetNodeUserDataClass(Sender: TojBaseVirtualTree; var NodeUserDataClass: TClass);
begin
  NodeUserDataClass:= TAlignData;
end;

//----------------------------------------------------------------------------------------------------------------------

procedure TAlignForm.AlignTreeFreeNode(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
//  var Data: PAlignData;
begin
//  Data := Sender.GetNodeData(Node);
//  Finalize(Data^);
...
initialization
  TojBaseVirtualTree.registerUserDataClass(TAlignData);
end.
