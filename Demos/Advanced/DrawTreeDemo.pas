...
//   - General use of TojVirtualDrawTree.
...
uses
  ...
  ojVirtualTrees, StdCtrls, {$ifdef GraphicEx} GraphicEx, {$else} JPEG, {$endif}
  ImgList, ComCtrls, UITypes;

type
  TDrawTreeForm = class(TForm)
    VDT1: TojVirtualDrawTree;
    Label7: TLabel;
    ...
    procedure VDT1CompareNodes(Sender: TojBaseVirtualTree; Node1, Node2: TojVirtualNode; Column: TColumnIndex;
      var Result: Integer);
    procedure VDT1DrawHint(Sender: TojBaseVirtualTree; Canvas: TCanvas; Node: TojVirtualNode; R: TRect; Column: TColumnIndex);
    procedure VDT1DrawNode(Sender: TojBaseVirtualTree; const PaintInfo: TVTPaintInfo);
    procedure VDT1FreeNode(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
    procedure VDT1GetHintSize(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; var R: TRect);
    procedure VDT1GetImageIndex(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Kind: TVTImageKind; Column: TColumnIndex;
      var Ghosted: Boolean; var Index: TImageIndex);
    procedure VDT1GetNodeWidth(Sender: TojBaseVirtualTree; Canvas: TCanvas; Node: TojVirtualNode; Column: TColumnIndex;
      var NodeWidth: Integer);
    procedure VDT1HeaderClick(Sender: TVTHeader; HitInfo: TVTHeaderHitInfo);
    procedure VDT1InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
    procedure VDT1InitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;
      var InitialStates: TVirtualNodeInitStates);
    procedure TrackBar1Change(Sender: TObject);
    procedure VDT1StateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
    procedure VDT1_OnGetNodeUserDataClass(Sender: TojBaseVirtualTree;
...
uses
  FileCtrl, ShellAPI, Mask, ShlObj, ActiveX, States, ojVirtualTrees.Utils;
...
var
  ...
  Mask: Cardinal;
begin
  //  EVENT _OnGetNodeUserDataClass
  //  VDT1.NodeDataSize := SizeOf(TShellObjectData);

  //  OR VTD1._UserDataCLass:= = TShellObjectData;
...
procedure TDrawTreeForm.VDT1InitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;
  var InitialStates: TVirtualNodeInitStates);
var
...
begin
  ...
  Data:= Node.UserData as TShellObjectData;
  ...
  begin
    ...
    try
      ...
      try
        ...
        if Cardinal(Data.Image.Height) + 4 > TojVirtualDrawTree(Sender).DefaultNodeHeight then
...
procedure TDrawTreeForm.VDT1FreeNode(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
var Data: TShellObjectData;
begin
  //  Data := Sender.GetNodeData(Node);
  Data:= Node.UserData as TShellObjectData;
  Data.Image.Free;
...
procedure TDrawTreeForm.VDT1DrawNode(Sender: TojBaseVirtualTree; const PaintInfo: TVTPaintInfo);
...
var
  ...
  R: TRect;
begin   
  with Sender as TojVirtualDrawTree, PaintInfo do
  begin
    //  Data := Sender.GetNodeData(Node);
    Data:= Node.UserData as TShellObjectData;
...
procedure TDrawTreeForm.VDT1GetNodeWidth(Sender: TojBaseVirtualTree; Canvas: TCanvas; Node: TojVirtualNode; Column: TColumnIndex;
  var NodeWidth: Integer);
...
var
  ...
  AMargin: Integer;
begin
  with Sender as TojVirtualDrawTree do
    AMargin := TextMargin;
  begin
    //  Data := Sender.GetNodeData(Node);
    Data:= Node.UserData as TShellObjectData;
...
procedure TDrawTreeForm.VDT1InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
// Called just before a node with children (only folder nodes can have children) is expanded.
var
  Data,
  ChildData: TShellObjectData;
  SR: TSearchRec;
  ChildNode: TojVirtualNode;
  NewName: String;
begin
  //  Data := Sender.GetNodeData(Node);
  Data:= Node.UserData as TShellObjectData;
  ...
  begin
    ...
    try
      repeat
        ...
        begin
          ...
          begin
            ...
            ChildData:= ChildNode.UserData as TShellObjectData;
      ...
      if ChildCount > 0 then
        Sender.Sort(Node, 0, TojVirtualStringTree(Sender).Header.SortDirection, False);
    finally
      FindClose(SR);
...
procedure TDrawTreeForm.VDT1GetImageIndex(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Kind: TVTImageKind;
...
procedure TDrawTreeForm.VDT1GetHintSize(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; var R: TRect);
...
procedure TDrawTreeForm.VDT1DrawHint(Sender: TojBaseVirtualTree; Canvas: TCanvas; Node: TojVirtualNode; R: TRect;
  Column: TColumnIndex);
...
procedure TDrawTreeForm.VDT1CompareNodes(Sender: TojBaseVirtualTree; Node1, Node2: TojVirtualNode; Column: TColumnIndex;
  var Result: Integer);
...
var
  Data1, Data2: TShellObjectData;
begin
  //  Data1 := Sender.GetNodeData(Node1);
  //  Data2 := Sender.GetNodeData(Node2);
  Data1:= Node1.UserData as TShellObjectData;
  Data2:= Node2.UserData as TShellObjectData;
...
procedure TDrawTreeForm.VDT1StateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
begin
  if not (csDestroying in ComponentState) then
    UpdateStateDisplay(Sender.TreeStates, Enter, Leave);
end;

procedure TDrawTreeForm.VDT1_OnGetNodeUserDataClass(Sender: TojBaseVirtualTree; var NodeUserDataClass: TClass);
begin
  NodeUserDataClass:= TShellObjectData;
end;
