...
uses
  ...
  Dialogs, ImgList, ojVirtualTrees, StdCtrls, ExtCtrls;

type
 THeaderOwnerDrawForm = class(TForm)
    Label8: TLabel;
    HeaderCustomDrawTree: TojVirtualStringTree;
    ...
    procedure HeaderCustomDrawTreeHeaderMouseDown(Sender: TVTHeader; Button: TMouseButton; Shift: TShiftState; X,
      Y: Integer);
    procedure HeaderCustomDrawTreeStateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
    procedure HeaderCustomDrawTreeGetText(Sender: TojBaseVirtualTree;
...
uses
  States, Types, ojVirtualTrees.Utils;
...
begin
  ...
  ojVirtualTrees.Utils.AlphaBlend(0, Bitmap.Canvas.Handle, R, Point(0, 0), bmConstantAlphaAndColor, Alpha,
...
procedure THeaderOwnerDrawForm.HeaderCustomDrawTreeStateChange(Sender: TojBaseVirtualTree; Enter, Leave: TVirtualTreeStates);
...
procedure THeaderOwnerDrawForm.HeaderCustomDrawTreeGetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode;
