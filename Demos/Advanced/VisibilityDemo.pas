...
uses
  ...
  StdCtrls, ojVirtualTrees, ComCtrls, ExtCtrls, ImgList;
...
type
  TVisibilityForm = class(TForm)
    ...
    Label3: TLabel;
    Label4: TLabel;
    procedure VST1InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
    procedure VST1InitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode; var InitialStates: TVirtualNodeInitStates);
    ...
    procedure VST3Scroll(Sender: TojBaseVirtualTree; DeltaX, DeltaY: Integer);
    procedure VST2InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
    procedure VST2Scroll(Sender: TojBaseVirtualTree; DeltaX, DeltaY: Integer);
    procedure VSTCollapsedExpanded(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
    procedure VST2Change(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
    ...
    procedure VST1GetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;var CellText: UnicodeString);
    procedure FormShow(Sender: TObject);
    procedure FormHide(Sender: TObject);
  private
    FChanging: Boolean;
    procedure HideNodes(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Data: Pointer; var Abort: Boolean);
  end;
...
type
  TLinkData = class
    ...
    OtherNode: TojVirtualNode;
  end;

//----------------------------------------------------------------------------------------------------------------------

procedure TVisibilityForm.VST1InitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;var InitialStates: TVirtualNodeInitStates);
var Level: Integer;
begin
...
procedure TVisibilityForm.VST1InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
begin
...
var
  Run1, Run2: TojVirtualNode;
  Data1, Data2: TLinkData;
begin
  ...
  VST2._UserDataClass:= TLinkData;
  VST2.RootNodeCount := 5;
  //VST3.NodeDataSize := SizeOf(TLinkData);
  VST3._UserDataClass:= TLinkData;
  ...
  begin
    //  Data1 := VST2.getUserData(Run1);
    Data1:= Run1.UserData as TLinkData;
    Data1.OtherNode := Run2;
    Data2 := Run2.UserData as TLinkData;
...
procedure TVisibilityForm.HideNodes(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Data: Pointer; var Abort: Boolean);
begin
...
procedure TVisibilityForm.VST2GetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex;
  TextType: TVSTTextType; var CellText: UnicodeString);
var
  Data: TLinkData;
begin
//  Data := Sender.GetNodeData(Node);
  Data:= Node.UserData as TLinkData;
...
procedure TVisibilityForm.VST3Scroll(Sender: TojBaseVirtualTree; DeltaX, DeltaY: Integer);
...
procedure TVisibilityForm.VST2Scroll(Sender: TojBaseVirtualTree; DeltaX, DeltaY: Integer);
// Synchronizes scroll offsets of VST2 and VST3.
begin
  if not FChanging then
  begin
...
procedure TVisibilityForm.VST2InitChildren(Sender: TojBaseVirtualTree; Node: TojVirtualNode; var ChildCount: Cardinal);
begin
...
procedure TVisibilityForm.VSTCollapsedExpanded(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
// Collapse/Expand state synchronization.
var
  OtherTree: TojBaseVirtualTree;
  Data: TLinkData;
begin
...
procedure TVisibilityForm.VST2Change(Sender: TojBaseVirtualTree; Node: TojVirtualNode);
...
procedure TVisibilityForm.VST1GetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex;
  TextType: TVSTTextType; var CellText: UnicodeString);
begin
