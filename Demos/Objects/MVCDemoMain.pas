...
uses Windows,Messages,SysUtils,Classes,Graphics,Controls,Forms,Dialogs,
     MVCTypes,MVCPanel,StdCtrls,ExtCtrls,ImgList,ojVirtualTrees,ComCtrls,
  Buttons;
...
type TfmMVCDemo=class(TForm)
       ...
       procedure TreeViewChange(Sender:TojBaseVirtualTree;Node:TojVirtualNode);
...
procedure TfmMVCDemo.TreeViewChange(Sender:TojBaseVirtualTree;Node:TojVirtualNode);
begin
  UpdateFromNode;
end;
