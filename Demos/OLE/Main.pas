...
uses 
  ...
  ojVirtualTrees, ActnList, ComCtrls, ExtCtrls, StdCtrls, Controls, Classes,
...
type
  TMainForm = class(TForm)
    ...
    Button1: TButton;
    Button3: TButton;
    Tree2: TojVirtualStringTree;
    Label1: TLabel;
    Tree1: TojVirtualStringTree;
    Label2: TLabel;
    ...
    procedure Tree1GetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;
      var Text: UnicodeString);
    procedure FormCreate(Sender: TObject);
    procedure TreeDragDrop(Sender: TojBaseVirtualTree; Source: TObject; DataObject: IDataObject;
      Formats: TFormatArray; Shift: TShiftState; Pt: TPoint; var Effect: Integer; Mode: TDropMode);
    procedure Button2Click(Sender: TObject);
    procedure TreeInitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;
      var InitialStates: TVirtualNodeInitStates);
    procedure Tree1NewText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; Text: UnicodeString);
    procedure Button3Click(Sender: TObject);
    procedure Tree2DragAllowed(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
    procedure TreeDragOver(Sender: TojBaseVirtualTree; Source: TObject; Shift: TShiftState; State: TDragState;
      Pt: TPoint; Mode: TDropMode; var Effect: Integer; var Accept: Boolean);
    procedure Tree2BeforeItemErase(Sender: TojBaseVirtualTree; Canvas: TCanvas; Node: TojVirtualNode; ItemRect: TRect;
      var ItemColor: TColor; var EraseAction: TItemEraseAction);
  private
    procedure AddUnicodeText(DataObject: IDataObject; Target: TojVirtualStringTree; Mode: TVTNodeAttachMode);
    procedure AddVCLText(Target: TojVirtualStringTree; const Text: UnicodeString; Mode: TVTNodeAttachMode);
    function FindCPFormatDescription(CPFormat: Word): string;
    procedure InsertData(Sender: TojVirtualStringTree; DataObject: IDataObject; Formats: TFormatArray; Effect: Integer;
...
uses
  TypInfo, ShlObj, UrlMon, ojVirtualTrees.ClipBoard;
...
var
  ...
  Fetched: Integer;
  Tree: TojVirtualStringTree;
  
begin
  if ActiveControl is TojVirtualStringTree then
  begin
    Tree := ActiveControl as TojVirtualStringTree;
...
procedure TMainForm.Tree1GetText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; TextType: TVSTTextType;
  var Text: UnicodeString);
...
begin
  ...
  begin
    ...
    Data:= Node.UserData as TNodeData;
    Text := Data.Caption;
  end
  else
    Text := '';
...
begin
  ...
  Tree1._UserDataClass:= TNodeData;
  Tree1.RootNodeCount := 30;
  //Tree2.NodeDataSize := SizeOf(TNodeData);
  Tree2._UserDataClass:= TNodeData;
...
procedure TMainForm.AddUnicodeText(DataObject: IDataObject; Target: TojVirtualStringTree; Mode: TVTNodeAttachMode);
...
procedure TMainForm.AddVCLText(Target: TojVirtualStringTree; const Text: UnicodeString; Mode: TVTNodeAttachMode);
...
procedure TMainForm.TreeDragDrop(Sender: TojBaseVirtualTree; Source: TObject; DataObject: IDataObject;
  Formats: TFormatArray; Shift: TShiftState; Pt: TPoint; var Effect: Integer; Mode: TDropMode);
  //--------------- local function --------------------------------------------
...
begin
  ...
  begin
    ...
    begin
      ...
      AddVCLText(Sender as TojVirtualStringTree, LogListBox.Items.CommaText, AttachMode);
  ...
  begin
    ...
    if Source is TojBaseVirtualTree then
    begin
      DetermineEffect;
    end
    else
    ...
    InsertData(Sender as TojVirtualStringTree, DataObject, Formats, Effect, AttachMode);
  end;
...
procedure TMainForm.TreeInitNode(Sender: TojBaseVirtualTree; ParentNode, Node: TojVirtualNode;
  var InitialStates: TVirtualNodeInitStates);
var
  Data: TNodeData;
begin
...
procedure TMainForm.Tree1NewText(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; Text: UnicodeString);
var
  Data: TNodeData;
...
procedure TMainForm.Tree2DragAllowed(Sender: TojBaseVirtualTree; Node: TojVirtualNode; Column: TColumnIndex; var Allowed: Boolean);
...
procedure TMainForm.TreeDragOver(Sender: TojBaseVirtualTree; Source: TObject; Shift: TShiftState; State: TDragState;
  Pt: TPoint; Mode: TDropMode; var Effect: Integer; var Accept: Boolean);
begin
  Accept := True;
end;
...
procedure TMainForm.Tree2BeforeItemErase(Sender: TojBaseVirtualTree; Canvas: TCanvas; Node: TojVirtualNode; ItemRect: TRect;
  var ItemColor: TColor; var EraseAction: TItemEraseAction);
...
procedure TMainForm.InsertData(Sender: TojVirtualStringTree; DataObject: IDataObject; Formats: TFormatArray;
      ...
      CF_UNICODETEXT:
        begin
          ...
          begin
            ...
            // as new nodes.
            AddUnicodeText(DataObject, Sender as TojVirtualStringTree, Mode);
