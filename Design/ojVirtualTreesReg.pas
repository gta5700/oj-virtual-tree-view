...
uses
  ...
  ColnEdit, ojVirtualTrees, ojVTHeaderPopup, ojVirtualTreesDesign;
...
uses
  ...
  ojVirtualTrees.ClipBoard, ojVirtualTrees.Actions;
...
var
  List: TStringList;
  I: Integer;
  Tree: TojBaseVirtualTree;

begin
  List := TStringList.Create;
  Tree := TClipboardFormats(GetOrdValue).Owner;
  EnumerateVTClipboardFormats(TojVirtualTreeClass(Tree.ClassType), List);
...
begin
  RegisterComponents('ojTam ojTam', [TojVirtualStringTree, TojVirtualDrawTree, TojVTHeaderPopupMenu]);
  //  RegisterComponentEditor(TojVirtualStringTree, TVirtualTreeEditor);
  //  RegisterComponentEditor(TojVirtualDrawTree, TVirtualTreeEditor);
  RegisterComponentEditor(TojVirtualStringTree, TojVirtualTreeEditor);
  RegisterComponentEditor(TojVirtualDrawTree, TojVirtualTreeEditor);

  RegisterPropertyEditor(TypeInfo(TClipboardFormats), nil, '', TClipboardFormatsProperty);

  // Categories:
  RegisterPropertiesInCategory(sActionCategoryName, TojBaseVirtualTree, ['ChangeDelay', 'EditDelay']);
