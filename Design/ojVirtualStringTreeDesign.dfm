object ojVirtualStringTreeDesignForm: TojVirtualStringTreeDesignForm
  Left = 0
  Top = 0
  ...
  object chStringOptionsList: TCheckListBox
    Left = 200
    Top = 333
    Width = 177
    Height = 56
    OnClickCheck = chStringOptionsListClickCheck
    ItemHeight = 13
    TabOrder = 5
    OnMouseMove = chStringOptionsListMouseMove
  end
  ...
  object btnRestoreStringOptions: TButton
    Left = 320
    Top = 315
    Width = 57
    Height = 17
    Caption = 'restore'
    TabOrder = 11
    OnClick = btnRestoreStringOptionsClick
  end
end
